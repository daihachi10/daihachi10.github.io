  ...
  steps: [
...

    {
      ...
      popover: {
        title: "ABOUT",
        description:
          "そもそも自作PCとはなにか、どんなメリットがあるかを簡単に説明しています。",
        side: "bottom",
        align: "center",
      },
    },
    ...
    },
    {
      ...
      popover: {
        title: "MOVIE",
        description: "CPUの3DVCACHEという機能についての詳しい動画です。",
        side: "bottom",
        align: "center",
      },
    },
    ...
    {
      element: "#step7",
      popover: { title: "GO!", description: "", side: "top", align: "center" },
    },
  ],
...
function about() {
  window.scrollTo({ top: window.innerHeight - 170, behavior: "smooth" });
}
function partslist() {
  window.scrollTo({ top: window.innerHeight + 430, behavior: "smooth" });
}
function movie() {
  window.scrollTo({ top: window.innerHeight + 1150 + 25, behavior: "smooth" });
}
function picture() {
  window.scrollTo({ top: window.innerHeight + 1705, behavior: "smooth" });
}
function performance() {
  window.scrollTo({ top: window.innerHeight + 2450, behavior: "smooth" });
}
...
window.addEventListener("scroll", (event) => {
  ...
  if (scrollY > window.innerHeight + 1739) {
    name = "PICTURE | BuildingPC Parts Introduction";
  } else if (scrollY > window.innerHeight + 884) {
    name = "MOVIE | BuildingPC Parts Introduction";
  } else if (scrollY > window.innerHeight + 301) {
    name = "PARTS LIST | BuildingPC Parts Introduction";
  } else if (scrollY > window.innerHeight - 240) {
    name = "ABOUT | BuildingPC Parts Introduction";
  } else {
    name = "HOME | BuildingPC Parts Introduction";
  }
  /*
    ク
    ソ
